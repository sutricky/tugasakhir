...
regresi linear lewat metode \texit{machine learning}, Persaman \ref{eq:raweq} harus
...
\texit{machine learning}. Dapat dilihat juga dari Persamaan \ref{eq:lineq} bahwa jumlah
...
pengukuran performa model \texit{machine learning} dalam bahasa Python \cite{pedregosa2011}.
Modul ini pertama kali dikembangkan oleh David Cournapeau pada 2007 dan
mencakup algoritma-algoritma \texit{machine learning} untuk skala menengah.
Scikit-learn digunakan untuk pembuatan model \texit{machine learning} pada karya tulis
ini.
