...
\nomenclature{\(C_{i}\)}{Kapasitas termal rata-rata \textit{node i}}
...
\nomenclature{\(i\)}{Sudut inklinasi orbit satelit}
\nomenclature{\(h\)}{Ketinggian orbit satelit}
...
\nomenclature{\(\frac{df}{dt}\)}{Turunan pertama fungsi terhadap waktu}
\nomenclature{\(f(x)\)}{Nilai fungsi pada waktu \textit{t}}
\nomenclature{\(f(x + \Delta t)\)}{Nilai fungsi pada waktu setelah selang waktu $\Delta t$}
\nomenclature{\(S\)}{Jumlah kuadrat selisih nilai prediksi model dengan nilai observasi}
\nomenclature{\(\hat{w}\)}{Matriks koefisien optimal yang meminimalkan \textit{S}}
\nomenclature{\(Q\)}{Matriks \textit{loading} Y pada pendekatan \textit{partial least squares}}
\nomenclature{\(F\)}{Matriks \textit{error} pada pendekatan \textit{partial least squares}}
\nomenclature{\(k\)}{Koefisien regularisasi pada pendekatan \textit{regularized least squares}}
\nomenclature{\(I\)}{Matriks identitas}
